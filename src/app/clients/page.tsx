  ...
  return (
    <div className='clients'>
      ...
      <div className="flex flex-col items-center justify-center p-5 my-10">
          ...
          Our Diverse Clients Portfolio
          </h1>
          <h2 className="mb-8 text-center text-2xl font-extrabold tracking-tight leading-none text-white md:text-2xl lg:text-5xl dark:text-white">
