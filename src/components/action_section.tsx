  ...
  return (
    <div style={{ height: '100vh', display: 'flex', alignItems: 'center' }} className="bg-black">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        ...
        <h2 className="my-6 mb-4 text-3xl font-extrabold tracking-tight leading-none text-white md:text-3xl lg:text-4xl dark:text-white">
          Let's create a winning strategy together
        </h2>
        <p className="mb-8 my-6 text-lg font-normal text-white lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">
